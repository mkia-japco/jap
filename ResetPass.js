...
export default class ResetPass extends React.PureComponent{
    ...
    SaveUserCode = () => { 
       ...
       if(password == null || phone == null) {
        ...
        fetch(`https://api.ebtekargheshm.ir/api/Account/ResetPassword?mobileOrEmail=${phone}`, {
            method: 'POST',
            headers : {
...
<View style={{width:325,height:60,borderRadius:4,backgroundColor:'#6a007e',justifyContent:'center',alignSelf:'center',marginTop:40,marginBottom:40}}>
<Text style={{fontFamily:'IRANYekanMobileBold',textAlign:'center',color:'#fff',fontSize:24,marginTop:-8}} >ارسال کد</Text>
</View>
</TouchableWithoutFeedback>
      }
