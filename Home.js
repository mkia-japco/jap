...
export default class Home extends React.PureComponent{
    ...
    get_user_data() {
        ...
        AsyncStorage.getItem('access_token', (error, result) => {
          fetch(`https://api.ebtekargheshm.ir/api/Account/GetUser`, {
              method: 'GET',
              headers : {
        ...
        return(
          ...
          content={<ScrollView style={styles.container}>
            ...
            <View style={{ flexDirection: 'row', marginTop: 25 }}>
              ...
              <Text style={{ fontFamily: 'IRANYekanMobileRegular', fontSize: 14, textAlign: 'left', color: '#526171', marginLeft: 19, marginTop: -2.5 }}>ارسال پیام</Text>
            </View>
            </TouchableOpacity>
