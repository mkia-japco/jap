...
export default class ResetPassChange extends React.PureComponent{
    ...
    SaveUserCode = () => { 
       ...
       if(password == null || password2 == null || phone == null) {
           Alert.alert(
               'خطا',
        ...
        const urlencoded = new URLSearchParams();
        urlencoded.append("mobileOrEmail", this.state.phone);
        urlencoded.append("OldPassword", this.state.password);
        urlencoded.append("NewPassword", this.state.password2);
        
        
        fetch('https://api.ebtekargheshm.ir/api/Account/ChangePassword', {
            method: 'POST',
            headers : {
...
<Text style={{fontFamily:'IRANYekanMobileRegular',textAlign:'center',color:'#6a007e',fontSize:18,width:330}} >نام کاربری (شماره همراه یا ایمیل)</Text>
          ...
          onChangeText={this.changePhone.bind(this)}
           />
            ...
            <Text style={{fontFamily:'IRANYekanMobileRegular',textAlign:'center',color:'#6a007e',fontSize:18,marginTop:15}} >رمز قدیمی</Text>
...
<Text style={{fontFamily:'IRANYekanMobileRegular',textAlign:'center',color:'#6a007e',fontSize:18,marginTop:15}} >رمز جدید</Text>
           
           <TextInput
           style={{textAlign:'center',fontSize:20,borderBottomColor:'#ccc',borderBottomWidth:1}} placeholder="********" placeholderTextColor="#ccc"
            onChangeText={this.changePass2.bind(this)}
            secureTextEntry={true} />
...
<Text style={{fontSize:13,fontFamily:'IRANYekanMobileRegular',lineHeight:20,color:'#988620',margin:20,textAlign:'left',marginRight:30}}>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است</Text>
          ...
          <Text style={{fontFamily:'IRANYekanMobileRegular',direction:'rtl',textAlign:'center',color:'#000',fontSize:16,marginTop:-5}} > حساب کاربری ندارید؟ <Text style={{fontFamily:'IRANYekanMobileRegular',color:'#6a007e',fontSize:16,marginRight:10,paddingRight:10,paddingLeft:10}}> ثبت نام کنید </Text></Text>
          </TouchableWithoutFeedback>

          <TouchableWithoutFeedback onPress={()=>{Actions.resetpass()}}>
          <Text style={{fontFamily:'IRANYekanMobileRegular',direction:'rtl',textAlign:'center',color:'#000',fontSize:16,marginTop:5}} > رمز عبور خود را فراموش کرده اید؟</Text>
          </TouchableWithoutFeedback>
   </Content>
