    ...
    render(){
        ...
        return(
            ...
            <Container style={{ backgroundColor: '#FAFAFA' }}>
                ...
                <Text style={{fontFamily:'IRANYekanMobileBold',fontSize:28,marginTop:-140,marginRight:18,color:'#fff'}}>ارتباط با شرکت</Text>

         
                <View style={{backgroundColor:'#fff',width:'95%',borderRadius:10,elevation:2,alignSelf:'center',marginTop:10,marginBottom:5}}>
                <Text style={{fontFamily:'IRANYekanMobileRegular',fontSize:16,marginTop:20,color:'#000',textAlign:'right',lineHeight:20,marginBottom:20,marginLeft:15,marginRight:15}}>فرم ارتباط با ما </Text>
                ...
                <Textarea multiline
                 ...
                 ,marginBottom:10}} placeholder="5000000 ریال" placeholderTextColor="#ccc"
                 />
