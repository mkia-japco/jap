...
export default class WalletAdd extends React.PureComponent{
    ...
    render(){
        ...
        return(
            ...
            <Container style={{ backgroundColor: '#FAFAFA' }}>
                ...
                <Text style={{fontFamily:'IRANYekanMobileBold',fontSize:28,marginTop:-140,marginRight:18,color:'#fff'}}>افزایش اعتبار</Text>
                ...
                <View style={{backgroundColor:'#fff',width:'95%',height:100,borderRadius:10,elevation:2,alignSelf:'center',marginTop:10,marginBottom:5}}>
                <Text style={{fontFamily:'IRANYekanMobileRegular',fontSize:16,marginTop:2,marginRight:18,color:'#000'}}>مبلغ شارژ دلخواه خود را وراد کنید</Text>
                <TextInput
              style={{textAlign:'right',fontSize:18,borderColor:'#ccc',borderWidth:1,fontFamily:'IRANYekanMobileRegular',alignSelf:'center',width:'95%',borderRadius:10,marginTop:10}} placeholder="5000000 ریال" placeholderTextColor="#ccc"
